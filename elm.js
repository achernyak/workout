...
Elm.Counter.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var buttonStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-size",_1: "2em"}
                                                    ,{ctor: "_Tuple2",_0: "width",_1: "2em"}
                                                    ,{ctor: "_Tuple2",_0: "background",_1: "white"}
                                                    ,{ctor: "_Tuple2",_0: "border",_1: "2px solid #DDD"}]));
   var countStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-size",_1: "1.5em"}
                                                   ,{ctor: "_Tuple2",_0: "font-family",_1: "monospace"}
                                                   ,{ctor: "_Tuple2",_0: "display",_1: "inline-block"}
                                                   ,{ctor: "_Tuple2",_0: "width",_1: "2em"}
                                                   ,{ctor: "_Tuple2",_0: "text-align",_1: "center"}]));
   var containerStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "1em"}]));
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,Decrement),buttonStyle]),_U.list([$Html.text("-")]))
              ,A2($Html.div,_U.list([countStyle]),_U.list([$Html.text($Basics.toString(model))]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,Increment),buttonStyle]),_U.list([$Html.text("+")]))]));
   });
